...
from methods import jsoncheck, dvanalysis, scoring, plotting, ellipticfit, sizecorr, voxelise
...
def meshandcollect_directData(jsondata, resultsPath=None):
    t0 = time.time()
    if resultsPath!=None:
        os.chdir(resultsPath)
    ...
    jsondata = jsoncheck.check2(jsondata, jobtype='meshandcollect')
