...
PARAMTABLE = {
                "wavelength" : {"entry" : "entry/instrument/beam/incident_wavelength", "attrs" : {'units': 'angstrom'}},
                "beam_center_x" : {"entry" : "entry/instrument/detector/beam_center_x", "attrs" : {'units': 'pixel'}},
                "beam_center_y" : {"entry" : "entry/instrument/detector/beam_center_y", "attrs" : {'units': 'pixel'}},
                ...
                "count_time" : {"entry" : "entry/instrument/detector/count_time", "attrs" : {'units': 's'}},
                ...
                "detector_readout_period" : {"entry" : "entry/instrument/detector/detectorSpecific/detector_readout_period", "attrs" : {'units': 's'}},
                ...
                "frame_count_time" : {"entry" : "entry/instrument/detector/detectorSpecific/frame_count_time", "attrs" : {'units': 's'}},
                "frame_period" : {"entry" : "entry/instrument/detector/detectorSpecific/frame_period", "attrs" : {'units': 's'}},
                ...
                "photon_energy" : {"entry" : "entry/instrument/detector/detectorSpecific/photon_energy", "attrs" : {'units': 'eV'}},
                ...
                "detector_distance" : {"entry" : "entry/instrument/detector/detector_distance", "attrs" : {'units': 'm'}},
                "detector_number" : {"entry" : "entry/instrument/detector/detector_number", "attrs" : {}},
                "detector_readout_time" : {"entry" : "entry/instrument/detector/detector_readout_time", "attrs" : {'units': 's'}},
                ...
                "frame_time" : {"entry" : "entry/instrument/detector/frame_time", "attrs" : {'units': 's'}},
                "detector_orientation" : {"entry" : "entry/instrument/detector/geometry/orientation", "attrs" : {'NX_class': 'NXorientation'}},
                "value" : {"entry" : "entry/instrument/detector/geometry/orientation/value", "attrs" : {}},
                "detector_translation" : {"entry" : "entry/instrument/detector/geometry/translation", "attrs" : {'NX_class': 'NXtranslation'}},
                "distances" : {"entry" : "entry/instrument/detector/geometry/translation/distances", "attrs" : {}},
                "two_theta" : {"entry" : "entry/instrument/detector/goniometer/two_theta", "attrs" : {'units': 'degree'}},
                "two_theta_end" : {"entry" : "entry/instrument/detector/goniometer/two_theta_end", "attrs" : {'units': 'degree'}},
                "two_theta_increment" : {"entry" : "entry/instrument/detector/goniometer/two_theta_increment", "attrs" : {'units': 'degree'}},
                "two_theta_range_average" : {"entry" : "entry/instrument/detector/goniometer/two_theta_range_average", "attrs" : {'units': 'degree'}},
                "two_theta_range_total" : {"entry" : "entry/instrument/detector/goniometer/two_theta_range_total", "attrs" : {'units': 'degree'}},
                "two_theta_start" : {"entry" : "entry/instrument/detector/goniometer/two_theta_start", "attrs" : {'units': 'degree'}},
                ...
                "sensor_thickness" : {"entry" : "entry/instrument/detector/sensor_thickness", "attrs" : {'units': 'm'}},
                "threshold_energy" : {"entry" : "entry/instrument/detector/threshold_energy", "attrs" : {'units': 'eV'}},
                "virtual_pixel_correction_applied" : {"entry" : "entry/instrument/detector/virtual_pixel_correction_applied", "attrs" : {}},
                "x_pixel_size" : {"entry" : "entry/instrument/detector/x_pixel_size", "attrs" : {'units': 'm'}},
                "y_pixel_size" : {"entry" : "entry/instrument/detector/y_pixel_size", "attrs" : {'units': 'm'}},
                "chi" : {"entry" : "entry/sample/goniometer/chi", "attrs" : {'units': 'degree'}},
                "chi_end" : {"entry" : "entry/sample/goniometer/chi_end", "attrs" : {'units': 'degree'}},
                "chi_increment" : {"entry" : "entry/sample/goniometer/chi_increment", "attrs" : {'units': 'degree'}},
                "chi_range_average" : {"entry" : "entry/sample/goniometer/chi_range_average", "attrs" : {'units': 'degree'}},
                "chi_range_total" : {"entry" : "entry/sample/goniometer/chi_range_total", "attrs" : {'units': 'degree'}},
                "chi_start" : {"entry" : "entry/sample/goniometer/chi_start", "attrs" : {'units': 'degree'}},
                "kappa" : {"entry" : "entry/sample/goniometer/kappa", "attrs" : {'units': 'degree'}},
                "kappa_end" : {"entry" : "entry/sample/goniometer/kappa_end", "attrs" : {'units': 'degree'}},
                "kappa_increment" : {"entry" : "entry/sample/goniometer/kappa_increment", "attrs" : {'units': 'degree'}},
                "kappa_range_average" : {"entry" : "entry/sample/goniometer/kappa_range_average", "attrs" : {'units': 'degree'}},
                "kappa_range_total" : {"entry" : "entry/sample/goniometer/kappa_range_total", "attrs" : {'units': 'degree'}},
                "kappa_start" : {"entry" : "entry/sample/goniometer/kappa_start", "attrs" : {'units': 'degree'}},
                "omega" : {"entry" : "entry/sample/goniometer/omega", "attrs" : {'units': 'degree'}},
                "omega_end" : {"entry" : "entry/sample/goniometer/omega_end", "attrs" : {'units': 'degree'}},
                "omega_increment" : {"entry" : "entry/sample/goniometer/omega_increment", "attrs" : {'units': 'degree'}},
                "omega_range_average" : {"entry" : "entry/sample/goniometer/omega_range_average", "attrs" : {'units': 'degree'}},
                "omega_range_total" : {"entry" : "entry/sample/goniometer/omega_range_total", "attrs" : {'units': 'degree'}},
                "omega_start" : {"entry" : "entry/sample/goniometer/omega_start", "attrs" : {'units': 'degree'}},
                "phi" : {"entry" : "entry/sample/goniometer/phi", "attrs" : {'units': 'degree'}},
                "phi_end" : {"entry" : "entry/sample/goniometer/phi_end", "attrs" : {'units': 'degree'}},
                "phi_increment" : {"entry" : "entry/sample/goniometer/phi_increment", "attrs" : {'units': 'degree'}},
                "phi_range_average" : {"entry" : "entry/sample/goniometer/phi_range_average", "attrs" : {'units': 'degree'}},
                "phi_range_total" : {"entry" : "entry/sample/goniometer/phi_range_total", "attrs" : {'units': 'degree'}},
                "phi_start" : {"entry" : "entry/sample/goniometer/phi_start", "attrs" : {'units': 'degree'}}
                }
...
class Stream2Hdf(FileWriter):
    ...
    def __decodeImage__(self, frames):
        ...
        if len(frames)==5 and self.__verbose__: # image appendix.
    ...
    def __setParam__(self, filehandler, key, data):
        ...
        try:
            ...
            for attr, v in param["attrs"].items():
