...
class DEigerClient(object):
    ...
    def fileWriterFiles(self, filename = None, param = None, method = 'GET'):
        """
        ...
        if method == 'GET':
            if filename is None:
                return self._getRequest(self._url('filewriter','files', parameter = param))["value"]
            else:
