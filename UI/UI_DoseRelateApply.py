...
# Form implementation generated from reading ui file 'DoseRelateApply.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.buttonBox.setStandardButtons(QtWidgets.QDialogButtonBox.Cancel|QtWidgets.QDialogButtonBox.YesToAll)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.ConsiderOrder.setItemText(0, _translate("Dialog", "Keep Dose"))
        self.ConsiderOrder.setItemText(1, _translate("Dialog", "Don\'t keep Dose"))
        self.ConsiderOrder.setItemText(2, _translate("Dialog", "Keep Dose &Change Range by Beamsize"))
