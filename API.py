...
from meshbest.algorithms import meshandcollect_directData,simple2
...
def runmeshandcollect(datalist1,session):
    ...
    try:
        ...
        #modify fir new version 
        data['steps_x']=data['grid_info']['steps_x']
        data['steps_y']=data['grid_info']['steps_y']
        data['detector_distance']=data['inputDozor']['detectorDistance'] 
        data['detectorPixelSize']=data['beamlineInfo']['detectorPixelSize']
        data['wavelength']=data['inputDozor']['wavelength']
        data['orgx']=data['inputDozor']['orgx']
        data['orgy']=data['inputDozor']['orgy']
        data['beam_h']=data['grid_info']['beam_width']*1000
        data['beam_v']=data['grid_info']['beam_height']*1000
        data['isZigZag']=False
        backdata = simple2(data)
